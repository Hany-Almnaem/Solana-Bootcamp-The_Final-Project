...
export const decodeDocumentMetadata = (decoded: Decoded): DocumentMetadata => ({
    documentType: decoded["document_type"] as string,
    issuer: decoded["issuer"] as string,
    issuanceDate: decoded["issuance_date"] as string,
    expirationDate: decoded["expiration_date"] as string,
    additionalInfo: decoded["additional_info"] as string,
...
export const DocumentMetadataSchema: Schema =  {
    struct: {
